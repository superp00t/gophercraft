...
func init5875() {
	...
	visItems.Uint32("PermEnchant", Public)
	visItems.Uint32("TempEnchant", Public)
	visItems.Uint32("InspectedEnchant", Public)
	visItems.Uint32("PropEnchant1", Public)
	visItems.Uint32("PropEnchant2", Public)
	visItems.Uint32("PropEnchant3", Public)
	visItems.Uint32("PropEnchant4", Public)
	visItems.Uint32("MaxEnchant", Public)
