...
var WorldTypeConversion = map[vsn.Build]map[WorldType]uint32{
	vsn.Alpha: {
		CMSG_BOOTME:                       0x0001,
		...
		SMSG_FORCE_RUN_SPEED_CHANGE:       0x00DF,
...
func init() {
	for build, descriptor := range WorldTypeConversion {
